...
export default function Help() {
    return (
        ...
        <div className="bg-white mt-24 ">
            <div>
                <div className="border-b bg-gray-100 py-3.5">
                ...
                <div className="ml-4 mt-3">
                    ...
                    <div className="relative">
                        <input className="mt-3 border rounded w-96 h-12 text-base mb-2 pl-10 pr-2" placeholder="Pesquisar na Ajuda" />
                        <IoSearch className="size-6 absolute left-3 top-1/2 transform -translate-y-1/2 text-xl" />
                    </div>


                </div>

                <div className="w-[400px] h-[225px] ml-3.5 rounded border mt-6">
            ...
            <div className="w-[400px] h-[225px] mt-40 rounded-md border ml-2">
